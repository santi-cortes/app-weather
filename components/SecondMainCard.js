...
const SecondMainCard = ({ activateFlip, setActivateFlip }) => {
	...
	return (
		<div className="absolute top-0 min-h-[360px] bg-white text-slate-950 dark:text-white dark:bg-slate-950 w-full border-4 flex flex-col gap-3 p-3 z-0 flip-card-back">
